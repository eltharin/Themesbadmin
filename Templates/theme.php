...
<html lang="fr">
  ...
  <head>
    ...
    <link href="/themesbadmin/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">

    <!-- Page level plugin CSS-->
    <link href="/themesbadmin/vendor/datatables/dataTables.bootstrap4.css" rel="stylesheet">

    <!-- Custom styles for this template-->
    <link href="/themesbadmin/css/sb-admin.css" rel="stylesheet">
...
?>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="/login/disconnect">Logout</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <script src="/themesbadmin/vendor/jquery-easing/jquery.easing.min.js"></script>
